...
// ---------------------------------------------------------------------------
  ...
  //
  Follower  devFollower;

  // Variables (management structures) used for the Follower application
  //
  IntegerValue  intMan1, intMan2, intMan3;  // Management structures for
  FloatValue    floatMan1, floatMan2;       // receiving 3 Integer variables,
  TextValue     textMan1;                   // 2 Float and 1 Text
